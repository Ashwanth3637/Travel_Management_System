...
function AdminLogin({ onLogin }) {
  ...
  const greetingText = "welcome to the admin dashboard";
    ...
    <div style={{
      ...
      <div className="glass-panel animate-fade-in" style={{
        ...
        <div style={{ marginTop: '20px', borderTop: '1px solid var(--border-color)', paddingTop: '15px', textAlign: 'center' }}>
          <span style={{ fontSize: '14px', color: 'var(--text-muted)' }}>Are you a rider? </span>
          <Link to="/customer/login" style={{ fontSize: '14px', color: 'var(--color-primary)', textDecoration: 'none', fontWeight: '600' }}>
