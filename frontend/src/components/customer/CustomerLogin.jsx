  ...
  return (
    <div style={{
      ...
      <div className="animate-fade-in" style={{
        ...
        {/* LEFT SIDE: Hero Visual Image & Features */}
        <div style={{
          position: 'relative',
          backgroundImage: "url('/travel_login_hero.png')",
          ...
          {/* Top Pill Badge */}
          <div style={{ position: 'relative', zIndex: 2, alignSelf: 'flex-start' }}>
            <div style={{
              display: 'inline-flex',
              alignItems: 'center',
              gap: '8px',
          ...
          <div style={{
            ...
            <div>
              ...
              <div style={{ fontSize: '12px', fontWeight: '700', color: '#ffffff' }}>Safe & Secure</div>
              <div style={{ fontSize: '10px', color: 'rgba(255,255,255,0.7)', marginTop: '2px' }}>Your data is protected</div>
            </div>
            <div>
              <div style={{ fontSize: '18px', marginBottom: '4px' }}>📍</div>
              <div style={{ fontSize: '12px', fontWeight: '700', color: '#ffffff' }}>Reliable Rides</div>
              <div style={{ fontSize: '10px', color: 'rgba(255,255,255,0.7)', marginTop: '2px' }}>Verified drivers</div>
            </div>
            <div>
              <div style={{ fontSize: '18px', marginBottom: '4px' }}>⏰</div>
              <div style={{ fontSize: '12px', fontWeight: '700', color: '#ffffff' }}>On Time Always</div>
              <div style={{ fontSize: '10px', color: 'rgba(255,255,255,0.7)', marginTop: '2px' }}>Punctual pickup</div>
            </div>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{ marginTop: '12px', textAlign: 'center', fontSize: '13px' }}>
            <span style={{ color: '#64748b' }}>Are you an admin? </span>
            <Link to="/admin/overview" style={{ color: '#2563eb', textDecoration: 'none', fontWeight: '700' }}>
              Go to Admin Login
            </Link>
          </div>
        </div>
